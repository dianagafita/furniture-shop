...
export default function ProductDetailPage({ params }) {
  ...
  if (!product) {
    return (
      <div className="m-auto min-h-[100vh] flex flex-col mx-7">
        Product not found
      </div>
    );
  }
  ...
  return (
    <div className="  min-h-[100vh]    text-white">
      <div className="flex flex-col-reverse  lg:flex-row w-full  ">
        {/* Product Info */}
        <div className="flex flex-col ml-7 md:pl-20 mt-10 lg:w-1/2 md:py-40 ">
        ...
        {/* Image Gallery */}
        <div className="lg:w-1/2  md:px-10 mt-20 md:pt-40 pb-20 md:py-40 m md:bg-[rgb(255,255,255,0.2)]">
